...
<section class="tab-content" id="doctorstats-tab"><div class="section-header"><h2><i class="fas fa-chart-column"></i> احصائيات الأطباء</h2><div class="search-box"><input type="text" id="doctorStatsSearch" placeholder="ابحث باسم الطبيب أو اختصاره..."><i class="fas fa-search"></i></div></div><div class="controls-row" style="margin-bottom:12px"><button class="filter-btn" id="sortHoursBtn" onclick="app.toggleDoctorStatsSort('hours')"><i class="fas fa-arrow-up-wide-short"></i> ترتيب الساعات</button><button class="filter-btn" id="sortShiftsBtn" onclick="app.toggleDoctorStatsSort('shifts')"><i class="fas fa-arrow-up-wide-short"></i> ترتيب عدد المناوبات</button></div><div class="table-wrapper desktop-table"><table><thead id="doctorStatsHead"></thead><tbody id="doctorStatsBody"></tbody></table></div><div class="mobile-cards" id="doctorStatsCards"></div></section>
